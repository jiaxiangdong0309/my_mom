...
```bash
python3 .claude/skills/query-knowledge-base/search/vector-search/query_vector.py "Python" --api-url http://localhost:7937
```
...
- `--api-url`: API 基础地址（默认: `http://localhost:7937`）
...
| 指定 API 地址 | `python3 .claude/skills/query-knowledge-base/search/vector-search/query_vector.py "查询内容" --api-url http://localhost:7937` |
